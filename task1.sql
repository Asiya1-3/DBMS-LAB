...
INSERT INTO Taxpayer
    (taxpayer_id, pan_number, full_name, date_of_birth, occupation, annual_income, email, is_active)
VALUES
    (107, 'GHJKL7890M', 'Anil Verma', '1993-04-25', 'Architect', 950000.00, 'anil.verma@example.com', TRUE);
UPDATE Taxpayer
...
INSERT INTO Income_Category
    (category_id, category_name, description, taxable)
VALUES
    (7, 'Rental Income', 'Income earned by leasing out residential or commercial property', TRUE);
...
VALUES
    (1, 'Central Income Tax Office', 'New Delhi'),
    (2, 'Regional Tax Office',       'Mumbai');
